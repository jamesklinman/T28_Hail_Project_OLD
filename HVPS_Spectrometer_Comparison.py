...
#true calculated airspeed
TASfile = pd.read_csv(TASfilename, sep=' * ')
#airplane data for naming the tables and plots
...
"""
#hvps data from SODA is already chunked into n seconds. Default from SODA is 5
HvpsPreChunk = 5
...
for y in range(HVPS_Indx_End - HVPS_Indx_Start): 
    if y==0:
        pass
    elif y%HvpsTimeRes == modulus_checker_thing: #this sums up over a period of n seconds or chunks. if 1 then %1 =0 if 2 then %2 = 1 if 3 then %3    #INDPT VAR
