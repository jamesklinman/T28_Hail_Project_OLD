...
to run: runfile('Aircraft_Track_Data.py', args='668.nc cfrad.668_172757_172829.000_CHILL_PPI.nc ParamInfoFolder/668_paramInfo.txt')
        runfile('Aircraft_Track_Data.py', args='Flight_Files/757.nc Radar_Files/cfrad.20000623_002721.000_to_20000623_003226.000_CHILL_PPI.nc Param_Info/757_paramInfo.txt')
...
filesave = 'Flight' + FlightNum + '_TrackData' + '.txt'
